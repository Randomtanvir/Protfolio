...
const About = () => {
  const skills = [
    { name: "Full Stack Developer", desc: "Specialized in React & Next.js", icon: "M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z", color: "blue" },
    { name: "UI/UX Designer", desc: "Creating engaging interfaces", icon: "M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z", color: "purple" }
  ];
      ...
      <div className="relative bg-white/40 dark:bg-gray-800/40 backdrop-blur-xl rounded-3xl p-8 border border-white/20 dark:border-gray-700/20 h-full">
        ...
        >
          ...
          <div>
            ...
            >
              I am a passionate web developer and designer with a keen eye for creating beautiful, 
              functional, and user-centered digital experiences. With expertise in both design 
          ...
          <div className="space-y-4">
            {skills.map((skill, index) => (
              ...
              >
                <div className={`absolute inset-0 bg-${skill.color}-500/10 rounded-2xl blur-xl transition-all duration-300 group-hover:bg-${skill.color}-500/20`} />
                <div className="relative bg-white/60 dark:bg-gray-800/60 backdrop-blur-sm rounded-2xl p-4 border border-white/20 dark:border-gray-700/20">
                  <div className="flex items-center space-x-4">
                    <div className={`w-12 h-12 rounded-xl bg-${skill.color}-500/10 flex items-center justify-center`}>
                      <svg className={`w-6 h-6 text-${skill.color}-500`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          >
            ...
            >
              <Button className="relative w-full px-8 py-4 font-medium text-white overflow-hidden rounded-xl group/btn">
                {/* Animated Background */}
                <div className="absolute inset-0 bg-gradient-to-r from-blue-500 via-indigo-500 to-blue-500 transition-all duration-700 group-hover/btn:scale-110" 
                  style={{ 
