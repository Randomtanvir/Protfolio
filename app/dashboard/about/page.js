                  ...
                  <AnimatePresence>
                    {skills.map((skill, index) => (
                      <motion.div
                        ...
                        className="group bg-gray-50 dark:bg-gray-700/50 rounded-xl border border-gray-200 dark:border-gray-600 p-6 hover:shadow-lg hover:border-blue-500 dark:hover:border-blue-400 transition-all"
                      >
                        <div className="flex items-center justify-between mb-4">
                          <div className="flex items-center gap-4">
                            <div className={`p-3 bg-${skill.color}-100 dark:bg-${skill.color}-900/30 rounded-lg`}>
                        ...
                        <div className="mt-4">
                          ...
                          <div className="w-full h-2 bg-gray-100 dark:bg-gray-600 rounded-full overflow-hidden">
                            <div
                              className={`h-full bg-${skill.color}-500 dark:bg-${skill.color}-400 rounded-full transition-all duration-300`}
