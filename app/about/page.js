...
const skills = [
  { name: "UI Design", level: "90%", color: "bg-gradient-to-r from-blue-500 to-blue-400" },
  { name: "Product Design", level: "80%", color: "bg-gradient-to-r from-purple-500 to-purple-400" },
  { name: "User Research", level: "85%", color: "bg-gradient-to-r from-indigo-500 to-indigo-400" },
  { name: "Coding", level: "60%", color: "bg-gradient-to-r from-cyan-500 to-cyan-400" },
  { name: "No Code Tools", level: "65%", color: "bg-gradient-to-r from-teal-500 to-teal-400" }
];
      ...
      <section className="py-20 relative overflow-hidden">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            >
              <h2 className="text-sm uppercase tracking-wider text-blue-500 dark:text-blue-400 font-semibold mb-3">ABOUT ME</h2>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              >
                <div className="bg-white/40 dark:bg-gray-800/40 backdrop-blur-xl rounded-3xl p-8 border border-white/20 dark:border-gray-700/20">
                  ...
                  >
                    A passionate web developer and designer with a keen eye for creating beautiful, functional, and user-centered digital experiences. With a background in both design and development, I bridge the gap between aesthetics and functionality.
                  </motion.p>
                  ...
                  >
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600 dark:text-gray-400">3+ years of web development</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600 dark:text-gray-400">B.Sc in Computer Science</p>
                      </div>
                    </div>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <motion.div 
              ...
              className="text-center mb-16"
            >
              <h2 className="text-sm uppercase tracking-wider text-blue-500 dark:text-blue-400 font-semibold mb-3">MY SKILLSET</h2>
              <h3 className="text-4xl lg:text-5xl font-bold bg-gradient-to-r from-gray-900 via-gray-700 to-gray-800 dark:from-white dark:via-gray-200 dark:to-gray-300 bg-clip-text text-transparent">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-20">
              <div className="space-y-8 bg-white/40 dark:bg-gray-800/40 backdrop-blur-xl rounded-3xl p-8 border border-white/20 dark:border-gray-700/20">
                <h4 className="text-xl font-semibold text-gray-900 dark:text-white mb-6">Core Skills</h4>
              ...
              <div className="relative">
                ...
                <div className="relative bg-white/40 dark:bg-gray-800/40 backdrop-blur-xl rounded-3xl p-8 border border-white/20 dark:border-gray-700/20 h-full">
                  <h4 className="text-xl font-semibold text-gray-900 dark:text-white mb-6">Technologies</h4>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-6">
              {["figma", "react", "next", "node", "javascript", "typescript"].map((tool, index) => (
                <motion.div
                  key={tool}
